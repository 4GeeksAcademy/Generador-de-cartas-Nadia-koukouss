...
window.onload = function () {
  ...
  function generateCard() {
    ...
    const color =
      palo === "corazones" || palo === "diamantes" ? "red" : "black";

    const div1 = document.createElement("div");
    div1.classList.add("div1");
    div1.innerHTML = `<span style="color: ${color}">${number} ${symbols[palo]}</span>`;

    const div2 = document.createElement("div");
    div2.classList.add("div2");
    div2.innerHTML = `<span style="color: ${color}">${symbols[palo]}</span>`;

    const div3 = document.createElement("div");
    div3.classList.add("div3");
    div3.innerHTML = `<span style="color: ${color}">${number} ${symbols[palo]}</span>`;
